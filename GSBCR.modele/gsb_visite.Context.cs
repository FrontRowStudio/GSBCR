...
namespace GSBCR.modele
{
    ...
    public partial class GSB_visite_3Entities : DbContext
    {
        public GSB_visite_3Entities()
            : base("name=GSB_visite_3Entities")
        {
        }
        ...
        public virtual int addRapport(string mat, Nullable<short> pPranum, Nullable<System.DateTime> pDatVisit, string pEtat, string pConf, string pBilan, string pMotif, string pAutre, string pNomR, string pPrenomR, string pMed1, string pMed2, Nullable<int> pNum)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("addRapport", matParameter, pPranumParameter, pDatVisitParameter, pEtatParameter, pConfParameter, pBilanParameter, pMotifParameter, pAutreParameter, pNomRParameter, pPrenomRParameter, pMed1Parameter, pMed2Parameter, pNumParameter);
        }
    
        public virtual int updRapport(string pMat, Nullable<short> pPranum, Nullable<System.DateTime> pDatVisit, string pEtat, string pConf, string pBilan, string pMotif, string pAutre, string pNomR, string pPrenomR, string pMed1, string pMed2, Nullable<int> pNum)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("updRapport", pMatParameter, pPranumParameter, pDatVisitParameter, pEtatParameter, pConfParameter, pBilanParameter, pMotifParameter, pAutreParameter, pNomRParameter, pPrenomRParameter, pMed1Parameter, pMed2Parameter, pNumParameter);
        }
    }
}
